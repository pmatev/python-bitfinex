...
class TradeClient:
    ...
    def past_funding_trades(self, symbol='usd', timestamp=0, limit=1000):
        """
        Fetch past funding trades
        :param timestamp:
        :param symbol:
        :return:
        """
        ...
        signed_payload = self._sign_payload(payload)
        r = requests.post(self.URL + "/mytrades_funding", headers=signed_payload, verify=True)
        json_resp = r.json()
